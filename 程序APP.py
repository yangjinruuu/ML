...
with st.form("prediction_form"):
    ...
    if submitted:
        ...
        input_data = pd.DataFrame([[
            wbc, crp, il6, pct, elderly, antimicrobial_use, urinary_catheter,
            fever_status, combination_therapy, special_class_antimicrobial,
            restricted_antimicrobial, bacterial_infection, 
            central_venous_catheter, disease_type, mechanical_ventilation
        ]], columns=[
            'WBC', 'CRP', 'IL6', 'PCT', 'Elderly', 'Antimicrobial use',
            'Urinary catheterization', 'Fever status', 
